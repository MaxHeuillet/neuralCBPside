...
class ALPS:
    ...
    def reset(self, d):
        ...
        self.model_info = {}
        self.F_class_info = {}
        self.label0 = torch.Tensor([0]).to(self.device)
        self.label1 = torch.Tensor([1]).to(self.device)
    ...
    def get_action(self, t, X):
        ...
        if t == 0:
            ...
            hn = learn(self.H_class, set_S, set_T, num_model=self.num_model, model_info=self.model_info, model=model)[0]
    ...
    def update(self, action, feedback, outcome, t, X, loss):
        ...
        update_xn(self.H_class, self.X, self.num_classes)
