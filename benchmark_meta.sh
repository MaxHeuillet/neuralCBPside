...
if [ "$case" == "case1" ]; then
    ...
    approaches=( 'neuronal' 'ineural') #'EEneuralcbpside_v5'  'EEneuralcbpside_v3' 'ineural' 'EEneuralcbpside_v2' 'EEneuralcbpside_v4' 'margin' 'cesa'
else
    context_type='MNIST'
    approaches=( 'neuronal' 'ineural') #'EEneuralcbpside_v5'  'EEneuralcbpside_v3' 'ineural' 'EEneuralcbpside_v2' 'EEneuralcbpside_v4'
fi
