...
if [ "$case" == "case1" ]; then
    ...
    approaches=( 'neuronal3' 'ineural3' 'neuronal6' 'ineural6' ) #'EEneuralcbpside_v5'  'EEneuralcbpside_v3' 'ineural' 'EEneuralcbpside_v2' 'EEneuralcbpside_v4' 'margin' 'cesa'
else
    context_type='MNIST'
    approaches=( 'neuronal3' 'ineural3' 'neuronal6' 'ineural6' ) #'EEneuralcbpside_v5'  'EEneuralcbpside_v3' 'ineural' 'EEneuralcbpside_v2' 'EEneuralcbpside_v4'
fi
