...
python3 ./benchmark.py --case ${CASE} --model ${MODEL} --horizon ${HORIZON} --n_folds ${NFOLDS} --approach ${APR} --context_type ${CONTEXT_TYPE} --id ${ID} > stdout_$SLURM_JOB_ID 2>stderr_$SLURM_JOB_ID
