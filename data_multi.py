...
class Bandit_multi:
    def __init__(self, name, is_shuffle=True, seed=None):
        ...
        #autres datasets du papier original, peut etre necessaire de rajouter as_frame = False, et parser argument
        ...
        self.y_arm = OrdinalEncoder(dtype=int).fit_transform( self.y.reshape((-1, 1)) )
        # cursor and other variables
        self.cursor = 0
        self.size = self.y.shape[0]
        self.n_arm = np.max(self.y_arm) + 1 # number of classes
