...
def evaluate_parallel(evaluator, game, nfolds):
    ...
    for seed in range(nfolds): #nfolds 
...
class Evaluation:
    ...
    def eval_policy_once(self, game, job):
        ...
        with gzip.open( './results/case4_{}_{}_{}_{}.pkl.gz'.format(self.context_type, self.horizon, self.n_folds, self.label) ,'ab') as f:
            pkl.dump(result,f)
        print('saved', jobid)
